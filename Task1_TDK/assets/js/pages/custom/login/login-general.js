...
function Login()
{
    var Loc = window.location.href + "/Login/GetLogin"
    Loading.BlockPage()
    ...
    $.ajax({
        ...
        success: function (j) {
            if (j.Result == true) {
                ...
                Notification.ShowToast('success', 'Login Success')
        ...
        $('#BtnSubmitLogin').on('click', function (e) {
            ...
            validation.validate().then(function(status) {
		        if (status == 'Valid') {
					...
					swal.fire({
		                text: "Sorry, Please input user name and password.",
		                icon: "error",
